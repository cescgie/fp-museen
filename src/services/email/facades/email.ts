...
export abstract class Email {
  // IMPORTANT
  //constants
  public static FROM_EMAIL: string = "s0540045@htw-berlin.de";
  public static FROM_NAME: string = "Yoggi Firmanda";
  public static TO_EMAIL: string = "yoggifirmanda@gmail.com";
  public static TO_NAME: string = "Yoggi Firmanda";
